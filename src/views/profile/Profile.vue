<template>
  <div id="profile">
    <nav-bar class="nav-bar"><div slot="center">美丽商城</div></nav-bar>
...
export default {
  ...
  data: function () {
    return {
      orderList: [
        {icon: '@/assets/img/profile/message.svg', info: '我的消息'},
        {icon: '~assets/img/profile/shopping.svg', info: '积分商城'},
        {icon: '~assets/img/profile/vip.svg', info: '会员卡'},
      ],
      serviceList: [
        {icon: '~assets/img/profile/cart.svg', iconColor: '#ff8198', info: '我的购物车'},
        {icon: '~assets/img/profile/pointer.svg', iconColor: '#ff8198', info: '下载购物APP'},
      ]
    }
  },
  mounted: function () {
